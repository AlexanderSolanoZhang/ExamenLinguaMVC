...
namespace ExamenLinguaMVC.Controllers
{
    public class InstructoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Correo,AniosExperiencia")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Correo,AniosExperiencia")] Instructor instructor)
        {
            if (id != instructor.Id)
            {
                return NotFound();
